...
if __name__ == "__main__":
    try:
        ce_logging ("Main","Script STARTED","DEBUG")
        ...
        # extract domains from customer addressess in the cust_dataset and hold in the set:
        ...
        ce_logging ("ValidateDomains_MX","Iterating extracted domains and testing for a valid MX record","DEBUG")
        ...
        ce_logging ("ValidateEmailAddressAndExport ","Validating MX records and exporting....","DEBUG")
